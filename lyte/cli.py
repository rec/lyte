    ...
    config = tyro.extras.subcommand_cli_from_dict(
        {
            ...
            'rehearse': rehearsal.RehearsalConfig,
            'saturation': SaturationConfig,
            'validate': show.ShowConfig,
            'fps-test': fps_test.FpsTestConfig,
            'dither-test': fps_test.TemporalDitherTestConfig,
            'timer': TimerConfig,
            'verify-output': fps_test.VerifyConfig,
