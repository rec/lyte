    ...
    class AuthorHandler(BaseHTTPRequestHandler):
        ...
        def do_POST(self) -> None:
            ...
            try:
                ...
                if path in {'/api/operation', '/api/timeline'}:
